...
const projects = [
  {
    title: "Лендинг для стоматології",
    task: "Пояснити переваги клініки, показати експертність лікарів і довести користувача до запису.",
    solution:
      "Побудував оффер навколо довіри, спростив шлях до заявки та зібрав мобільну структуру без зайвих блоків.",
  },
  {
    title: "Лендинг для будівельної компанії",
    task: "Системно подати послуги, показати рівень виконання робіт і підсилити потік звернень з реклами.",
    solution:
      "Вирівняв меседжі, додав сильний перший екран, кейси та CTA в ключових точках перегляду сторінки.",
  },
  {
    title: "Лендинг для освітнього продукту",
    task: "Зробити сторінку, яка швидко пояснює цінність навчання і знімає заперечення перед оплатою.",
    solution:
      "Зібрав текстову структуру під прогрів, блоки з результатами та зрозумілий сценарій для заявки або консультації.",
  },
];
        ...
        <section className="section" id="projects">
          <div className="container">
            <div className="section-heading">
              ...
              <h2>Приклади сторінок під різні ніші</h2>
              <p className="section-copy">
                Нижче показую, як підходжу до задач у різних нішах: через оффер,
                логіку блоків та чіткий шлях до дії.
              </p>
            </div>
